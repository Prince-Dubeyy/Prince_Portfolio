    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            Aspiring Data Scientist specializing in Machine Learning, Analytics, Forecasting, SQL, Power BI, and Business Intelligence. Passionate about transforming raw data into actionable insights that drive smarter decisions.
          </motion.p>
        ...
        <div className="flex-1 relative w-full max-w-md lg:max-w-none h-[400px] hidden md:block">
          <motion.div
            ...
            animate="animate"
            className="absolute top-10 right-20 glass p-4 rounded-xl border border-white/10 shadow-2xl backdrop-blur-md"
          >
          ...
          <motion.div
            ...
            className="absolute top-40 left-10 glass p-4 rounded-xl border border-white/10 shadow-2xl backdrop-blur-md"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-yellow-500/20 flex items-center justify-center text-yellow-400 font-bold">BI</div>
              <div>
          ...
          <motion.div
            ...
            className="absolute bottom-20 right-10 glass p-4 rounded-xl border border-white/10 shadow-2xl backdrop-blur-md"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold">SQL</div>
              <div>
                <p className="text-sm font-semibold text-white">Data Analytics</p>
                <p className="text-xs text-gray-400">Querying & ETL</p>
              </div>
            </div>
          </motion.div>
        </div>
